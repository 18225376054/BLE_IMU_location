...
#         on Windows (e.g. Cygwin, MSYS2). Defaults to 'posix' during export.  #
...
#            Defaults to 'linux' during export. Can be overridden externally.  #
...
ifeq (, $(UNAME))
  ifneq (, $(filter $(MAKECMDGOALS), export))
    # Set the default UNAME for exporting.
    override UNAME = linux
  else
    # Run uname command.
...
ifeq (, $(filter $(OS), win posix))
  ifneq (, $(filter $(MAKECMDGOALS), export))
    # Set the default OS for exporting.
    override OS := posix
